...
public class MusicListAdapter extends RecyclerView.Adapter {
    ...
    private Track mCurrentBean;

    public MusicListAdapter(ArrayList<Track> audioBeans, Track bean, Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        final Track bean = mAudioBeans.get(position);
    ...
    //更新Adater状态
    public void updateAdapter(Track bean) {
        mCurrentBean = bean;
